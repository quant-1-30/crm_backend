...
class TestLogin:
    ...
    @pytest.fixture
    def patch(self):
        return urljoin("http://localhost:8100", "/login/")
    ...
    @pytest.fixture
    def patch_register(self):
        params = {"name": "test", "phone": 13776668123, "verify_code": "648831", "passwd": "test"}
        return params
    
    @pytest.fixture
    def patch_login(self):
        params = {"name": "test", "passwd": "test"}
        return params
